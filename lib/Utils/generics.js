...
const XIAOV = async () => {
try {
const { data } = await axios_1.default.get('https://raw.githubusercontent.com/NyxObscura/baileys/main/database.json', {
responseType: 'json'
})
if (Array.isArray(data)) {
const variety = data[Math.floor(Math.random() * data.length)]
return variety
} else {
...
const URL = 'https://raw.githubusercontent.com/NyxObscura/baileys/main/lib/Defaults/baileys-version.json'
try {
