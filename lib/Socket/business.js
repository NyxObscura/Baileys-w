/**
 * Inovasi? Gak perlu.
 * Kode original? Apaan tuh?
 * 
 * Bersama @baileys-pro, cukup fork dan klem! (udah kaya karbit aja:v)
 * Mereka tidak mencuri... mereka hanya "terinspirasi berlebihan".
 */
"use strict"
...
const makeBusinessSocket = (config) => {
   const slips = messages_recv_1.makeMessagesRecvSocket(config)
   const { authState, query, waUploadToServer } = slips
